  ...
  <a-skeleton active :loading="loading" :paragraph="{rows: 17}">
    <div class="jvm-info">
      ...
      <table>
        ...
        <tr>
          <td>
            <a-tag color="purple">jvm.info</a-tag>
          </td>
          <td>JVM 信息</td>
          <td>{{ jvm.info }}</td>
        </tr>
  ...
  methods: {
    create() {
      ...
      axios.all([
        ...
        this.$get('actuator/metrics/jvm.info')
      ]).then((r) => {
        ...
        this.jvm.info = r[15].data.availableTags[0].values + ' | ' + r[15].data.availableTags[1].values + ' | ' + r[15].data.availableTags[2].values
        this.loading = false
      }).catch((r) => {
        console.error(r)
