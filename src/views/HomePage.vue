    ...
    <a-row :gutter="8" class="count-info">
      ...
      <a-col :span="12" class="project-wrapper">
        <a-card title="进行中的项目" class="project-card">
          <a href="https://github.com/CHExN?tab=stars" target="_blank" slot="extra">所有项目</a>
          <table>
            <tr>
              <td>
  ...
  data () {
    return {
      ...
      projects: [
        {
          name: 'No-Code',
          des: 'The best way to write secure and reliable applications. Write nothing; deploy nowhere.',
          avatar: 'N'
        },
        {
          name: 'CS-Notes',
          des: '📚技术基础知识、Leetcode、计算机操作系统、计算机网络、系统设计。',
          avatar: 'F'
        },
        {
          name: 'Hacker-Laws-zh',
          des: '💻📖对开发人员有用的定律、理论、原则和模式。(Laws, Theories, Principles and Patterns that developers will find useful.)',
          avatar: 'F'
        },
        {
          name: 'Mini-Spring',
          des: '简化版的spring框架，能帮助你快速熟悉spring源码和掌握spring的核心原理。',
          avatar: 'M'
        },
        {
          name: 'Sa-Token',
          des: '一个轻量级 Java 权限认证框架。',
          avatar: 'M'
        }
      ],
      todayIp: '',
